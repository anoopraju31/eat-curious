...
const Enquiry = () => {
	return (
		<section className='w-full py-[var(--padding-y)] md:py-[var(--padding-y-sm)] lg:py-[var(--padding-y-lg)] px-[var(--padding-x)] md:px-[var(--padding-x-sm)] xl:px-[var(--padding-x-lg)] relative bg-[var(--black)] lg:flex lg:justify-between lg:flex-wrap lg:items-start '>
			{/* Contact Info */}
			<div className='relative text-center lg:text-left text-[var(--white)] lg:w-[393px] '>
			...
			{/* Contact Form */}
			<div className='mt-20 mb-[50px] lg:my-0 lg:w-1/2 lg:order-2'>
				<form className=''>
					<div>
						{/* Name */}
						<div className='mb-4'>
						...
						{/* Contact */}
						<div className='mb-4'>
							<label htmlFor='contact-number' className='hidden'>
								{' '}
								Contact Number{' '}
							</label>
							<input
						...
						{/* Interest */}
						<div className='mb-4'>
							<label htmlFor='interest-in' className='hidden'>
								{' '}
								Interest In{' '}
							</label>
							<select
						...
						<div className='mb-4'>
							...
							<textarea
								...
								rows={10}
								cols={50}
								className='w-full h-[10em] px-[1.3em] pt-[0.7em] pb-[1.3em] m-0 mb-0 appearance-none font-medium tracking-[0.01em] font-heading-narrow text-[18px] text-[var(--white)] text-left leading-[1.25em] uppercase rounded border-none outline-none shadow-none bg-[rgba(255,246,246,0.1)]  placeholder:text-[rgba(4,47,26,0.5)] focus:shadow-inset'></textarea>
						</div>
					</div>

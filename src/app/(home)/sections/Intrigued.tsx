...
const Intrigued = () => {
	return (
		<section
			id='intrigued'
			className='w-full mt-[5vw] sticky top-0 bg-[var(--white)] text-center text-[var(--black)] before:content-[""] before:block before:absolute before:bottom-[100%] before:left-0 before:right-0 before:h-[5vw] before:bg-repeat-x before:bg-top before:bg-curve-white md:before:bg-curve-white-md xl:before:bg-curve-white-xl before:bg-curve-size xl:before:bg-curve-size-xl before:z-50'>
